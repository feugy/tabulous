...
export { default as ControlsHelp } from './ControlsHelp/index.js'
...
export { default as GameAside } from './GameAside.svelte'
export { default as GameHand } from './GameHand.svelte'
