...
<ToolBox name="Routes/home/Catalog Item" layout="centered">
  <Tool
  ...
  <Tool
    name="With characteristics and copyright"
    props={{
      game: {
        name: 'klondike',
        locales,
        ...
        maxSeats: 4,
        copyright: {
          authors: [{ name: 'John Doe' }, { name: 'Jane Lark' }],
          designers: [{ name: 'Amy Banks' }, { name: 'Mark Loom' }],
          publishers: [
            { name: 'Awesome games' },
            { name: 'Games from elsewhere' }
          ]
        }
      }
    }}
